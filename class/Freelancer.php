<?php
    class Freelancer {
        ...
        public function getFreelancer(){
            $query = "SELECT * FROM " . $this->table . ' JOIN about ON freelancer.about_id = about.about_id';
        ...
        public function getFreelancerById($id){
            $query = "SELECT * FROM " . $this->table . " JOIN about ON freelancer.about_id = about.about_id WHERE freelancer_id = :id";
            $stmt = $this->conn->prepare($query);
            $stmt->execute([":id" => $id]);
        ...
        public function getProfilePicture($id){
            $query = "SELECT profile_pic FROM " . $this->table . " WHERE freelancer_id = :id";
            $stmt = $this->conn->prepare($query);
            $stmt->execute([":id" => $id]);
            return $stmt->fetch(PDO::FETCH_ASSOC);
        }
        ...
        public function updateFreelancer($freelancerId, $firstName, $lastName, $address, $profilePic) {
        ...
        public function freelancerLogin($email, $password){
